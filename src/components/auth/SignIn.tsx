        ...
        <div className='bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10'>
            ...
            <div className='mt-8'>
                <button
                    ...
                    className='flex items-center justify-center text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full'
                    onClick={handleSignIn}
                >
                    {isLoading ? <Loading className='ml-1.5' /> : 'Sign in'}
                </button>
            </div>
        </div>
    );
