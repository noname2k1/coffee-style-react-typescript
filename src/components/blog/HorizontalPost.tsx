    ...
    return (
        ...
        >
            ...
            <div className='flex flex-col pl-10 pr-5 max-lg:mt-10'>
                <h3 className='mb-2.5 text-xl dark:text-white'>
                    {props.item.title}
                </h3>
                <p
                    className='mb-2.5 text-black/60 dark:text-white/60 cursor-default'
                ...
                <span
                    onClick={(e) => e.preventDefault()}
                    className='text-black/60 dark:text-white/60 uppercase cursor-default tracking-widest text-xs font-xs'
                >
